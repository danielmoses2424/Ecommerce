    ...
    <div className='py-8'>
      <div className='container'>
        ...
        lg:grid-cols-4 gap-8'> 
           ...
           {/* third col */}
           <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl 
           relative h-[320px] flex items-end '>
            <div>
              <div className=' mb-4'>
            ...
            <img
             src={image3} 
             alt=""
            className='w-[350px] absolute top-1/2 -translate-y-1/2 
            -right-0' 
             />
           </div>
        </div>
