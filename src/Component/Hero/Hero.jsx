...
const Hero = () => {
  ...
  return (
    <div className='container'>
        <div className='overflow-hidden rounded-3xl min-h-[550]
        sm:min-h-[650px] hero-bg-color flex justify-center items-center w-full '> 
                  ...
                  <div key={data.id}>
                    <div className='grid grid-cols-1 sm:grid-cols-2' >
                      ...
                      sm:text-left order-2 sm:order-1 relative z-10'>
                        ...
                        dark:text-white/5 sm:text-[80px] md:text-[100px] lg:text-[150px] font-bold'>{data.title2}
                        </h1>
                      <div>
                      <Button 
                      ...
                      <div className='order-1 sm:order-2'>
                        <div>
                          ...
                          mx-auto drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] relative
                           z-40'
                          />
                        </div>
                      </div>
